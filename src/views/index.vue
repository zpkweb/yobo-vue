<template>
  <q-layout @scroll="Top">
    <div class="carousel1 relative-position">
          ...
          <div class="menu text-white text-bold">
            ...
            <div class="menu-item">
              ...
              <q-breadcrumbs class="menu-el" separator="|" gutter="md">
                ...
                <q-breadcrumbs-el label="漆器" class="text-white" />
              </q-breadcrumbs>
            </div>
            <div class="menu-item">
              <div class="menu-title">其他</div>
              <q-breadcrumbs class="menu-el" separator="|" gutter="md">
                <q-breadcrumbs-el label="艺术资讯" class="text-white" />
                <q-breadcrumbs-el label="VR看展" class="text-white" />
                <q-breadcrumbs-el label="行业画展" class="text-white" />
              </q-breadcrumbs>
            </div>
          </div>
        </div>
      ...
      >
        <q-carousel-slide :name="1" img-src="img/index/painting.png" />
        <q-carousel-slide
          :name="2"
